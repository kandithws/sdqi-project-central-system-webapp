...
exports.isLoggedIn = function (req, res, next) {
    if (req.isAuthenticated()){
        ...
        req.flash('error', 'Please login to proceed!').then(res.redirect('/signin'));
    }    
}
...
exports.isAdmin = function (req, res, next){
    if (req.user.role == "admin"){
        ...
        req.flash('error', 'You are not authorize to access this page, Admins Only!').then(res.redirect('/'))
    }
}
